...
def search_cards():
    # Main program
    card_name = easygui.enterbox("Enter the name of the card you want to search for:")
    if card_name in monster_cards:
        ...
        easygui.msgbox("Card not found in the catalogue.", "Search Cards")
